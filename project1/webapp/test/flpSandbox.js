		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "객실 주문 내역",
									"targetURL": "#sapsyncproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapsyncproject1-display": {
								"semanticObject": "sapsyncproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.sync.project1",
									"url": sap.ui.require.toUrl("sap/sync/project1")
								}
							}
						}
					}
